...
//Social Media Icons in Menus - WPBeginner
...
function storm_social_icons_networks($networks) {
    ...
    $extra_icons = array(
        '/feed' => array(// Enable this icon for any URL containing this text
            'name' => 'linkedin-square', // Default menu item label
            'class' => 'linkedin-square', // Custom class
            'icon' => 'icon-linkedin-square', // FontAwesome class
            'icon-sign' => 'icon-linkedin-square-sign' // May not be available. Check FontAwesome.
        ),
    );
...
//New size for post thumbnails
add_image_size('portafolio-landing', 9999, 250, true);
